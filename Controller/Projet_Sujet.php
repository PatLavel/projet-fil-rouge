...
<body>
    ...
    if (isset($_POST["envoyer"])) {
        $reponse = (new Reponse())->setMessage($_POST["message"]);
            ...
            <div class="col-lg-8">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="" method="POST">
                                                    <div class="modal-body">
                                                        <textarea class="form-control" id="reponseMessage" name="message" placeholder="Entrer votre réponse..." rows="5" autofocus required></textarea>
                                                    </div>
                ...
                <div class="rounded block_rep">
                    <div class="bar_info_rep">
                        <div class="nb_rep">203 Réponses</div>
                    ...
                    <div class="block_sujet_rep">
                        ...
                        ?>
                            <div class="sujet_rep">
                                ...
                                <div class="footer_suj">
                                    <div>
                                        <a href="" class="repondre_footer_suj">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="orange" class="bi bi-reply-fill" viewBox="0 0 16 16">
                                                <path d="M5.921 11.9 1.353 8.62a.719.719 0 0 1 0-1.238L5.921 4.1A.716.716 0 0 1 7 4.719V6c1.5 0 6 0 7 8-2.5-4.5-7-4-7-4v1.281c0 .56-.606.898-1.079.62z" />
                                            </svg>
                                            <span style="color: orange;">Répondre</span>
                                        </a>
                                    </div>
                                    <div>
                                        <button class="button_footer_suj">
